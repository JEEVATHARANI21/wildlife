  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 md:p-10 font-sans">
      ...
      >
        ...
        <div className="shrink-0 relative z-20 flex items-center justify-between border-b border-[#242923] bg-[#111511] px-6 md:px-8 py-3.5 shadow-md">
          <div className="flex items-center gap-2">
            <span className="text-[#D6A85C]">💳</span>
            <span className="font-sans text-xs tracking-[0.2em] uppercase font-bold text-[#D6A85C]">
              Payment & Cancellation Policy
            </span>
          </div>
          <span className="text-[10px] font-sans uppercase tracking-wider text-[#A7A59B] bg-[#151815] px-2.5 py-0.5 rounded-full border border-[#242923]">
            Official Charter
          </span>
        </div>
        ...
        >
          {/* Payment & Cancellation Policy Content */}
